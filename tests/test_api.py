...
def test_course_studio_page_and_mobile_safe_board_grid():
    ...
    assert '/static/studio.js?v=20260902-validation-position-link' in page.text
    ...
    assert './studio-document.mjs?v=20260902-validation-position-link' in studio_source
